...
const navItems = [
  { href: "/dashboard", label: "Dashboard", icon: "dashboard", fillIcon: true },
  { href: "/subjects", label: "Subjects", icon: "book", fillIcon: false },
  { href: "/goals", label: "Goals", icon: "target", fillIcon: false },
  { href: "/events", label: "Events", icon: "calendar_today", fillIcon: false },
  { href: "/leaderboard", label: "Leaderboard", icon: "leaderboard", fillIcon: false },
...
export function Sidebar({
  ...
  return (
    <aside className="hidden md:flex bg-white fixed left-0 top-0 h-full flex-col z-40 border-r border-[#E5E5E5] w-64">
      {/* Brand */}
      <div className="p-sm border-b border-[#E5E5E5]">
        ...
        {userName && (
          <p className="font-label-mono text-xs text-[#6B7280] mt-1">
            {userLevel} · {userName}
          </p>
        )}
        {!userName && (
      ...
      {/* Footer */}
      <div className="p-sm border-t border-[#E5E5E5]">
        <button className="w-full border border-[#E5E5E5] text-[#6B7280] font-label-mono text-xs py-2 rounded hover:text-primary hover:border-primary transition-colors">
          Upgrade to Pro
        </button>
      </div>
    </aside>
