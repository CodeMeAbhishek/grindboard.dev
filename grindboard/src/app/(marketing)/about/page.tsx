export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto py-12 space-y-8">
      <h1 className="text-4xl md:text-5xl font-display-xl text-[#1A1A1A] tracking-tight">About Grindboard</h1>
      ...
      <div className="space-y-6 pt-6">
        <h2 className="text-2xl font-display-xl text-[#1A1A1A]">Our Mission</h2>
        <p className="text-lg text-[#6B7280] leading-relaxed">
      ...
      <div className="space-y-6 pt-6">
        <h2 className="text-2xl font-display-xl text-[#1A1A1A]">Why Gamification?</h2>
        <p className="text-lg text-[#6B7280] leading-relaxed">
      ...
      <div className="bg-[#F0FDF4] border border-[#10B981]/20 rounded-2xl p-8 mt-12 text-center">
        ...
        <p className="text-[#6B7280] mb-6">Stop grinding in silence. Start building your streak today.</p>
