...
import { SiFacebook, SiNetflix, SiGoogle, SiMeta } from "react-icons/si";
    ...
    <div className="space-y-32">
      ...
      <section className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-20 pt-10">
        <div className="flex-1 space-y-6 text-center lg:text-left">
          ...
          <h1 className="text-5xl md:text-7xl font-display-xl text-[#1A1A1A] tracking-tighter leading-[1.1]">
          ...
          <p className="text-lg md:text-xl italic font-bold text-[#1A1A1A] max-w-2xl mx-auto lg:mx-0">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start pt-4">
            ...
            <a href="#features" className="w-full sm:w-auto px-8 py-4 rounded-xl font-bold text-[#6B7280] hover:text-[#1A1A1A] transition-all text-lg flex items-center justify-center gap-2">
              View Features
            </a>
          </div>
          <div className="pt-6 flex items-center gap-4 justify-center lg:justify-start text-sm font-label-mono text-[#6B7280]">
      ...
      {/* Crack FAANG Section */}
      <section id="features" className="bg-white border border-[#E5E5E5] rounded-3xl p-8 md:p-16 shadow-panel relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-bl from-[#F0FDF4] to-transparent pointer-events-none" />
        <div className="flex flex-col md:flex-row items-center gap-12 relative z-10">
          <div className="flex-1 order-2 md:order-1 relative h-[400px] w-full">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[400px] h-full">
              <div className="absolute top-[10%] left-[15%] animate-float" style={{ animationDelay: '0s' }}>
                <div className="w-20 h-20 bg-white rounded-[1.5rem] shadow-xl flex items-center justify-center border border-[#E5E5E5]/50 rotate-[-12deg]">
                  <SiMeta className="text-4xl text-[#0668E1]" />
                </div>
              </div>
              
              <div className="absolute top-[65%] left-[5%] animate-float" style={{ animationDelay: '1s' }}>
                <div className="w-24 h-24 bg-white rounded-[1.8rem] shadow-lg flex items-center justify-center border border-[#E5E5E5]/50 rotate-[15deg]">
                <FaAmazon className="text-5xl text-[#FF9900]" />
                </div>
              </div>

              <div className="absolute top-[35%] left-[50%] -translate-x-1/2 -translate-y-1/2 animate-float" style={{ animationDelay: '2s' }}>
                <div className="w-32 h-32 bg-white rounded-[2rem] shadow-2xl flex items-center justify-center border border-[#E5E5E5]/50 z-10">
                  <SiGoogle className="text-7xl text-[#4285F4]" />
                </div>
              </div>

              <div className="absolute top-[15%] right-[10%] animate-float" style={{ animationDelay: '1.5s' }}>
                <div className="w-20 h-20 bg-white rounded-[1.5rem] shadow-lg flex items-center justify-center border border-[#E5E5E5]/50 rotate-[20deg]">
                  <SiNetflix className="text-4xl text-[#E50914]" />
                </div>
              </div>

              <div className="absolute top-[60%] right-[15%] animate-float" style={{ animationDelay: '0.5s' }}>
                <div className="w-24 h-24 bg-white rounded-[1.8rem] shadow-xl flex items-center justify-center border border-[#E5E5E5]/50 rotate-[-15deg]">
                  <SiFacebook className="text-5xl text-[#0866FF]" />
                </div>
              </div>
            </div>
          </div>
          <div className="flex-1 space-y-6 order-1 md:order-2">
            ...
            <h2 className="text-3xl md:text-5xl font-display-xl text-[#1A1A1A] tracking-tight">
      ...
      <section className="space-y-12">
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-display-xl text-[#1A1A1A] tracking-tight">Everything you need to stay consistent.</h2>
          <p className="text-lg text-[#6B7280]">We've combined the best elements of gamification with serious study tools to make the grind addictive.</p>
        </div>
        
        <div className="grid md:grid-cols-3 gap-6">
          {/* Feature 1 */}
          <div className="bg-white border border-[#E5E5E5] p-8 rounded-2xl shadow-sm hover:shadow-md transition-all group">
            ...
            <h3 className="text-xl font-bold text-[#1A1A1A] mb-3">Streaks & XP</h3>
          ...
          <div className="bg-white border border-[#E5E5E5] p-8 rounded-2xl shadow-sm hover:shadow-md transition-all group">
            ...
            <h3 className="text-xl font-bold text-[#1A1A1A] mb-3">Community Leaderboards</h3>
            <p className="text-[#6B7280] leading-relaxed">
          ...
          <div className="bg-white border border-[#E5E5E5] p-8 rounded-2xl shadow-sm hover:shadow-md transition-all group">
            ...
            <h3 className="text-xl font-bold text-[#1A1A1A] mb-3">Contest Radar</h3>
            <p className="text-[#6B7280] leading-relaxed">
