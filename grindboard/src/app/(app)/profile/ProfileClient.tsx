  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <header className="bg-white border border-[#E5E5E5] shadow-panel rounded-xl p-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <button className="flex items-center gap-2 border border-[#E5E5E5] hover:border-primary hover:text-primary text-[#6B7280] rounded px-4 py-2 font-label-mono text-sm transition-colors">
      ...
      <section className="bg-white border border-[#E5E5E5] shadow-panel p-lg rounded-xl">
        <h2 className="font-headline-lg-mobile text-[#1A1A1A] tracking-tight mb-4">Linked Accounts</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
          ...
          <div className="flex items-center justify-between p-md bg-[#F9FAFB] rounded-lg border border-[#E5E5E5]">
            ...
            <button className={`px-4 py-1 text-xs border rounded font-label-mono transition-colors ${initialUser.cfHandle ? "border-[#E5E5E5] text-[#6B7280] hover:text-primary hover:border-primary bg-white" : "bg-[#F0FDF4] text-primary border-primary/30 hover:bg-primary hover:text-white"}`}>
              {initialUser.cfHandle ? "Refresh" : "Sync Now"}
            </button>
          </div>
          {/* LeetCode */}
          <div className="flex items-center justify-between p-md bg-[#F9FAFB] rounded-lg border border-[#E5E5E5]">
            ...
            <button className={`px-4 py-1 text-xs border rounded font-label-mono transition-colors ${initialUser.lcHandle ? "border-[#E5E5E5] text-[#6B7280] hover:text-primary hover:border-primary bg-white" : "bg-[#F0FDF4] text-primary border-primary/30 hover:bg-primary hover:text-white"}`}>
              {initialUser.lcHandle ? "Refresh" : "Sync Now"}
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white border border-[#E5E5E5] shadow-panel p-lg rounded-xl">
        <div className="flex justify-between items-center mb-4">
          <h2 className="font-headline-lg-mobile text-[#1A1A1A] tracking-tight">Activity</h2>
